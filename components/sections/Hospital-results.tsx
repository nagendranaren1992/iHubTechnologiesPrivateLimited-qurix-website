      ...
      <div className="container-custom">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            <div className="relative overflow-hidden bg-[#14bbd3] rounded-[40px] p-8 md:p-12 text-white shadow-2xl">
              {/* Branded "Ball" Shapes from Screenshot */}
              <div className="absolute -right-24 -top-12 w-[440px] h-[440px] rounded-full opacity-40 pointer-events-none"></div>
              <div className="absolute -right-20 top-[-50%] w-[300px] h-[300px] bg-[#0e7490] rounded-full opacity-30 pointer-events-none"></div>
