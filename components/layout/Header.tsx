...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md shadow-sm">
      ...
      {/* Mobile Menu Overlay - Moved outside nav for better layering */}
      <div
        className={`fixed inset-x-0 bottom-0 z-40 bg-white/98 backdrop-blur-xl transition-all duration-500 md:hidden overflow-y-auto ${
          isMenuOpen
